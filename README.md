...
- **Timeline tab** — The **Dasha Wheel** and **Ashtakvarga Wheel**, a written **Timeline Forecast** of upcoming Mahā/Antardashā windows with tone and dates, the **Prediction Confidence** transparency card, and **Gochar** (live transits, including Sade Sati phase).
