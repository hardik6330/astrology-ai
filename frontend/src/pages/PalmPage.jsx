          ...
          <div style={{ animation: "slideUp 0.8s ease-out" }}>
            ...
            <div className="grid-2" style={{ margin: "20px 0" }}>
              {c.grownStronger?.length > 0 && (
                ...
                >
                  <p style={{ fontSize: 15, fontWeight: 700, color: "#4ade80", marginBottom: 14 }}>
                    ✦ Grown Stronger
                  </p>
              ...
              {c.watchPoints?.length > 0 && (
                ...
                >
                  <p style={{ fontSize: 15, fontWeight: 700, color: "#fbbf24", marginBottom: 14 }}>
                    ✦ Still Showing Up
                  </p>
            ...
            {c.lifeAdvice && (
              <div
                className="cosmic-card"
                style={{ borderColor: "rgba(168,85,247,0.25)", background: "rgba(30,20,45,0.5)" }}
              >
                <p style={{ fontSize: 15, fontWeight: 700, color: "#c084fc", margin: "0 0 10px" }}>
                  🎯 Direction
                </p>
              ...
              return (
                ...
                >
                  <span style={{ fontSize: 13, fontWeight: 600, minWidth: 0 }}>
                    ...
                    {bad && (
                      <span style={{ fontSize: 10, color: "#f87171", marginLeft: 8 }}>· unreadable</span>
                    )}
                  </span>
        ...
        <div className="cosmic-card" style={{ textAlign: "center", padding: "2rem 1.25rem" }}>
          {!preview && !scanning && (
            <>
              ...
              <p style={{ fontSize: 15, fontWeight: 600, color: "#fff", margin: "0 0 6px" }}>
                Scan Your Palm
              </p>
              ...
              <div style={{ display: "grid", gap: 10 }}>
                <button
                  ...
                  style={{
                    ...
                    cursor: gating ? "wait" : "pointer",
                    color: "#fff",
                    textAlign: "left",
                    width: "100%",
                    opacity: gating ? 0.5 : 1,
                  }}
                >
              ...
              {gating && (
                <p style={{ color: "#94a3b8", fontSize: 13, textAlign: "center", margin: "12px 0 0" }}>
                  Reading photo…
                </p>
              )}
        ...
        <div style={{ animation: "slideUp 0.8s ease-out" }}>
          ...
          {palm.practicalGuidance && (palm.practicalGuidance.career || palm.practicalGuidance.love) && (
            <div
              ...
              style={{ borderColor: "rgba(168,85,247,0.25)", background: "rgba(30,20,45,0.5)" }}
            >
              <p style={{ fontSize: 15, fontWeight: 700, color: "#c084fc", margin: "0 0 4px" }}>
                🎯 Practical Guidance
              </p>
          ...
          {palm.palmistryNotes?.length > 0 && (
            <div
              className="cosmic-card"
              style={{ borderColor: "rgba(99,102,241,0.25)", background: "rgba(20,22,40,0.5)" }}
            >
              <p style={{ fontSize: 15, fontWeight: 700, color: "#a5b4fc", margin: "0 0 4px" }}>
        ...
        (() => {
          ...
          return (
            ...
            >
              ...
              <p style={{ fontSize: 16, fontWeight: 700, color: "#f87171", margin: "0 0 8px" }}>
                {info.title}
              </p>
